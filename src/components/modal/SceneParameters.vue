<template>
  <div>
    <v-row justify="center">
      <v-dialog v-model="showSceneParameters" scrollable max-width="800px">
        <v-card>
          ...
          <v-divider></v-divider>
          <v-card-actions>
            <v-btn color="blue darken-1" text @click="closeSceneParameters"
              >Cancelar</v-btn
            >
            <v-btn color="blue darken-1" text @click="validateSceneParameters"
              >Pesquisar</v-btn
            >
          </v-card-actions>
        </v-card>
