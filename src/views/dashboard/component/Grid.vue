<template>
  <v-container id="grid" fluid tag="section">
    ...
    <v-row class="text-center">
      ...
      <v-col v-for="n in 3" :key="`cols-${n}`" cols="4" class="pt-0">
        <v-card class="mt-0">
      ...
      <v-col v-for="n in 3" :key="`sm-${n}`" cols="12" sm="4" class="pt-0">
        <v-card class="mt-0">
          <v-card-text class="red--text text--darken-4">
            col-sm-4
          </v-card-text>
      ...
      <v-col v-for="n in 3" :key="`md-${n}`" cols="12" md="4" class="pt-0">
        <v-card class="mt-0">
          <v-card-text class="red--text text--darken-4">
            col-md-4
          </v-card-text>
      ...
      <v-col v-for="n in 3" :key="`lg-${n}`" cols="12" lg="4" class="pt-0">
        <v-card class="mt-0">
          <v-card-text class="red--text text--darken-4">
            col-lg-4
          </v-card-text>
      ...
      <v-col v-for="n in 3" :key="`xl-${n}`" cols="12" xl="4" class="pt-0">
        <v-card class="mt-0">
          <v-card-text class="red--text text--darken-4">
            col-xl-4
          </v-card-text>
      ...
      <v-col v-for="n in 4" :key="`mixed-${n}`" sm="6" lg="3" class="pt-0">
        <v-card class="mt-0">
          <v-card-text class="red--text text--darken-4">
            col-xl-4
          </v-card-text>
    ...
    <v-row class="text-center">
      <v-col v-for="n in 2" :key="`offset-${n}`" class="ml-auto mr-auto" md="4">
        <v-card class="mt-0">
          <v-card-text class="red--text text--darken-4">
            col-md-4 ml-auto mr-auto
          </v-card-text>
